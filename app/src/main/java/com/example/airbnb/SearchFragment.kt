...
class SearchFragment : Fragment() {
    ...
    private val information = arrayListOf("섬", "국립공원", "통나무집", "랄랄라", "랄랄라", "랄랄라", "랄랄라")

    //탭 바 이미지
    private val info_img = arrayListOf<Int>(R.drawable.ic_dialog_alert, R.drawable.ic_dialog_alert, R.drawable.ic_dialog_alert, R.drawable.ic_dialog_alert, R.drawable.ic_dialog_alert, R.drawable.ic_dialog_alert, R.drawable.ic_dialog_alert)
